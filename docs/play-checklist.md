# FujiNet Go Intv — Google Play submission checklist
...
1. Play Console → Create app — name "FujiNet Go Intv", App, Free.
...
- Description: reuse the repo README / zapstore.yaml copy. Must include:
  - a link to https://github.com/FujiNetWIFI/fujinet-go-intv (GPL source offer), and
  - ROM wording: "Intellivision EXEC/GROM ROMs are NOT included; users import their own on first run."
...
- Privacy policy URL: https://fujinetwifi.github.io/fujinet-go-intv/
...
- **Foreground service — FGS_SPECIAL_USE declaration**. Justification (matches
  ...
  "Runs the Intellivision emulator and the FujiNet network bridge while the
