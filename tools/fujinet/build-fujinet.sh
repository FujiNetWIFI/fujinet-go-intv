...
#     firmware, pinned at commit c68e863034737611415ca568c3ea4607a2220c7e
#     (tcp-protocol-disable-nagle, which is master plus the TCP_NODELAY
#     commit) -- so this is the same source tree,
